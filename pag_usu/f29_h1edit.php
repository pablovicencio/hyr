...
<br>
    ...
    <div class="col-3 f29span f29">
        ...
        <div class="input-group mb-3 col-12 f29span">
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C585" name="C585"  aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        </div>
    ...
    <div class="col-3 f29span f29">
        ...
        <div class="input-group mb-3 col-12 f29span">
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C586"  name="C586" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
        </div>
    ...
    <div class="col-3 f29span f29">
        ...
        <div class="input-group mb-3 col-12 f29span">
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C142"  name="C142" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        </div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C731" name="C731" aria-describedby="basic-addon4" >
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C732" name="C732" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<!-- END Linea 3 -->
    ...
    <div class="col-3 f29span f29">
        ...
        <div class="input-group mb-3 col-12 f29span">
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C714" name="C714" aria-describedby="basic-addon4" >
        </div>
    ...
    <div class="col-3 f29span f29">
        ...
        <div class="input-group mb-3 col-12 f29span">
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C715"  name="C715" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
        </div>
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C515" name="C515"  aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    </div>
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C587" name="C587"  aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    </div>
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C720" name="C720" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    </div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C503" name="C503" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C502" name="C502" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C763" name="C763" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C764"  name="C764" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C716" name="C716" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C717" name="C717" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C110" name="C110" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C111" name="C111"  aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C758" name="C758" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C759" name="C759" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C512" name="C512" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C513" name="C513" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C509" name="C509" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C510"  name="C510" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C708" name="C708" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C709" name="C709" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C733"  name="C733" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C734" name="C734" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C516" name="C516" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C517" name="C517" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C500" name="C500" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C501" name="C501" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<!-- END Linea 17 -->
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C154"  name="C154" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
    </div>
...
<!-- END Linea 18 -->
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C518" name="C518" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
    </div>
...
<!-- END Linea 19 -->
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C713" name="C713" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
    </div>
 ...
 <!-- Linea 21 -->
    <div class="col-6 f29span f29">
        ...
        <div class="input-group-prepend">   
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C738" name="C738" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C739" name="C739" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        </div>    
    ...
    <div class="col-6 f29">
        ...
        <div class="col-6 f29span f29">
            ...
            <div class="input-group-prepend">   
                ...
                <input type="number" value="0" class="form-control f29 f29inp" id="C740" name="C740" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
            ...
            <div class="input-group-prepend">   
                ...
                <input type="number" value="0" class="form-control f29 f29inp" id="C741" name="C741" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
                <div class="input-group-append">
                    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
                </div>
            </div>    
...
<div class="col-3 f29span">
    ...
    <div class="input-group-prepend">   
        ...
        <input type="number"  value="0" class="form-control f29 f29inp" id="C538" name="C538" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">=</span>
    </div>
    </div> 
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C511" name="C511" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C514"  name="C514" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C564" name="C564" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C521" name="C521" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C566"  name="C566" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C560" name="C560" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C584" name="C584" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C562" name="C562" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C519" name="C519" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C520"  name="C520" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C761" name="C761"  aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C762"  name="C762" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C765" name="C765" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C766" name="C766" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C524" name="C524" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C525"  name="C525" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C527" name="C527" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C528" name="C528" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C531" name="C531" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C532" name="C532" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C534" name="C534" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C535"  name="C535" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="col-3 f29span f29">
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C536" name="C536" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    </div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C553"  name="C553" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<!-- Linea 35 -->
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C504" name="C504" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
        <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
    </div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C593"  name="C593" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C594" name="C594" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C592" name="C592" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C539" name="C539" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C718" name="C718" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C164"  name="C164" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<!-- END Linea % -->
 ...
 <div class="col-6 f29span f29">
        ...
        <div class="input-group-prepend">   
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C730" name="C730" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
            <span class="input-group-text f29 f29span  text-center" id="basic-addon4">Base </span>
            <span class="input-group-text f29 f29span  text-center" id="basic-addon4">742 </span>
            <input type="number" value="0" class="form-control f29 f29inp" id="C742" name="C742" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
        </div>    
    ...
    <div class="col-6 f29">
        ...
        <div class="col-6 f29span f29">
            ...
            <div class="input-group-prepend">   
                ...
                <input type="number" value="0" class="form-control f29 f29inp" id="C743" name="C743"  aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
            ...
            <div class="input-group-prepend">   
                ...
                <input type="number" value="0" class="form-control f29 f29inp" id="C127" name="C127" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                <div class="input-group-append">
                    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
                </div>
            </div>    
 ...
 <!-- ENDLinea 42 -->
  ...
  <div class="col-6 f29span f29">
        ...
        <div class="input-group-prepend">   
            ...
            <input type="number" value="0" class="form-control f29 f29inp" id="C729" name="C729" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
            <span class="input-group-text f29 f29span  text-center" id="basic-addon4">Base </span>
            <span class="input-group-text f29 f29span  text-center" id="basic-addon4">744 </span>
            <input type="number" value="0" class="form-control f29 f29inp" id="C744" name="C744" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
        </div>    
    ...
    <div class="col-6 f29">
        ...
        <div class="col-6 f29span f29">
            ...
            <div class="input-group-prepend">   
                ...
                <input type="number" value="0" class="form-control f29 f29inp" id="C745" name="C745" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
            ...
            <div class="input-group-prepend">   
                ...
                <input type="number" value="0" class="form-control f29 f29inp" id="C544" name="C544" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
                <div class="input-group-append">
                    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
                </div>
            </div>    
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C523" name="C523" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C712"  name="C712" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C757" name="C757" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">-</span>
</div>
</div>
...
<div class="col-3 f29span">
    ...
    <div class="input-group-prepend">   
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C537" name="C537" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
        <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">=</span>
    </div>
    </div> 
...
<div class="col-3  f29span f29">
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C77" name="C77" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C89"  name="C89" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C760" name="C760" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C50" name="C50" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="col-3  f29span f29">
    ...
    <div class="input-group mb-3 col-12 f29span">
        ...
        <input type="number" value="0" class="form-control f29 f29inp" id="C751" name="C751" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
        <div class="input-group-prepend">
            <span class="input-group-text f29 f29span f29num" id="basic-addon4">735</span>
        </div>
        <input type="number" value="0" class="form-control f29 f29inp" id="C735" name="C735" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span f29">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C48"  name="C48" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
    </div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C151" name="C151" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C153" name="C153" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C54" name="C54" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C56" name="C56" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C588" name="C588" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C589" name="C589" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
           ...
           <div class="input-group-prepend">
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C30" name="C30" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C563" name="C563" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" step=".01" class="form-control f29 f29inp" id="C115" name="C115" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C68" name="C68" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
...
<div class="col-3 f29span f29">
                    ...
                    <div class="input-group-prepend">
                        ...
                        <input type="number" value="0" class="form-control f29 f29inp" id="C62" name="C62" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
                    </div>
           ...
           <div class="input-group-prepend">
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C565" name="C565" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C120" name="C120" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C542" name="C542" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C122"  name="C122" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
                            </div>
                        </div>
...
<div class="col-3 f29span f29">
                    ...
                    <div class="input-group-prepend">
                        ...
                        <input type="number" value="0" class="form-control f29 f29inp" id="C123"  name="C123" aria-describedby="basic-addon4" onkeyup="calcularHojauno()">
                        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
                    </div>
           ...
           <div class="input-group-prepend">
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C700" name="C700" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C701" name="C701" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C702" name="C702" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
                        ...
                        <div class="col-3 f29span f29">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="0" class="form-control f29 f29inp" id="C711" name="C711" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                            </div>
                        </div>
...
<div class="col-3 f29span f29">
                    ...
                    <div class="input-group-prepend">
                        ...
                        <input type="number" value="0" class="form-control f29 f29inp" id="C703" name="C703" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
                        <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
                    </div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C66" name="C66" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C152" name="C152" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0" class="form-control f29 f29inp" id="C70" name="C70" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    <div class="input-group-append">
    <span class="input-group-text f29 f29num" id="basic-addon2 ">+</span>
</div>
</div>
...
<div class="input-group mb-3 col-12 f29span">
    ...
    <input type="number" value="0"  class="form-control f29 f29inp" id="C595" name="C595" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    <div class="input-group-append">
...
<div class="col-6 f29span f29">
    <div class="input-group-prepend">
    <input type="text" placeholder = "Apellido Paterno o Razón Social" class="form-control f29 f29inp" id="C1"  name="C1" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    </div>
</div>

<div class="col-3 f29span f29">
<div class="input-group-prepend">
    <input type="text" placeholder = "Apellido Materno" class="form-control f29 f29inp" id="C2" name="C2" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
    </div>
</div>

<div class="col-3 f29span f29">
<div class="input-group-prepend">
    <input type="text" placeholder = "Nombres" class="form-control f29 f29inp" id="C5" name="C5" aria-describedby="basic-addon4"  onkeyup="calcularHojauno()">
    </div>
</div>
...
<div class="col-12 f29span f29">
    ...
    <div class="col-6 f29span f29">
        <div class="input-group-prepend">
            ...
            <input type="text" placeholder = "(Si marca con X el casillero, registre los cambios al reverso)" class="form-control f29 f29inp" id="C583" name="C583" aria-describedby="basic-addon4" onkeyup="calcularHojauno()" >
        </div>
    </div>
...
<div class="input-group col-12 f29span f29">
  ...
  <input type="number" value="0" class="form-control f29 f29inp" id="C91" name="C91" aria-describedby="basic-addon3" onkeyup="calcularHojauno()">
  <span class="input-group-text f29 f29num f29bold" id="basic-addon2 ">=</span>
</div>
...
<div class="input-group col-12 f29span f29">
  ...
  <input type="number" value="0" class="form-control f29 f29inp" id="C92" name="C92" aria-describedby="basic-addon3" onkeyup="calcularHojauno()">
  <span class="input-group-text f29 f29num f29bold" id="basic-addon2 ">+</span>
</div>
...
<div class="input-group col-12 f29span f29">
  ...
  <input type="number" value="0" class="form-control f29 f29inp" id="C93" name="C93" aria-describedby="basic-addon3" onkeyup="calcularHojauno()">
  <span class="input-group-text f29 f29num f29bold" id="basic-addon2 ">+</span>
</div>
...
<div class="input-group col-12 f29span f29">
  ...
  <input type="number" value="0" class="form-control f29 f29inp" id="C94" name="C94" aria-describedby="basic-addon3" onkeyup="calcularHojauno()">
  <span class="input-group-text f29 f29num f29bold" id="basic-addon2 ">=</span>
</div>
